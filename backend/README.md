...
## Project Structure
    ...
    ├── ckc_breed_standards_43557  # Django project configurations
...
1. Clone this repo and `cd ckc_breed_standards_43557`
...
2. Clone this repo and `cd ckc_breed_standards_43557`
